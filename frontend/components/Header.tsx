  ...
  return (
    <>
      <header className="border-b border-oq-700 sticky top-0 z-50" style={{ background: '#050806' }}>
        <div className="max-w-[1600px] mx-auto px-5 h-nav-height flex items-center justify-between">
          {/* Logo */}
          ...
          {/* Settings */}
          <button onClick={() => setSettingsOpen(true)} className="p-1.5 rounded hover:bg-oq-800 transition-colors text-oq-300 hover:text-oq-100" title="Settings">
